...
<div class="main-container">
		...
		<script src="<?php echo base_url(); ?>clip-one/assets/plugins/flot/jquery.flot.js"></script>
		<script src="<?php echo base_url(); ?>clip-one/assets/plugins/flot/jquery.flot.pie.js"></script>
		<script src="<?php echo base_url(); ?>clip-one/assets/plugins/flot/jquery.flot.resize.min.js"></script>
		<script src="<?php echo base_url(); ?>clip-one/assets/plugins/jquery.sparkline/jquery.sparkline.js"></script>
		<script src="<?php echo base_url(); ?>clip-one/assets/plugins/jquery-easy-pie-chart/jquery.easy-pie-chart.js"></script>
		<script src="<?php echo base_url(); ?>clip-one/assets/plugins/jquery-ui-touch-punch/jquery.ui.touch-punch.min.js"></script>
		<script src="<?php echo base_url(); ?>clip-one/assets/plugins/fullcalendar/fullcalendar/fullcalendar.js"></script>
		<script src="<?php echo base_url(); ?>clip-one/assets/js/index.js"></script>
