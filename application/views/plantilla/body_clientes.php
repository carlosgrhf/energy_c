									...
									<i class="clip-home-2"></i>
										Clientes
                                                        ...
                                                        <div class="page-header">
                                                                <h1>Clientes <small>Clientes dados de alta actualmente en la aplicación</small></h1>
                                                        </div>
						</div>
					</div>
					<!-- end: PAGE HEADER -->
							...
							<div class="panel panel-default">
								...
								<div class="panel-body">
									<div class="table-responsive">
                                                                            <a class="btn btn-primary tooltips" href="<?php echo base_url(); ?>clientes/nuevo" data-placement="right" data-original-title="Añadir nuevo cliente">
										...
										<table class="table table-bordered table-hover" id="sample-table-1">
											...
											<tbody>
                                                                                                ...
                                                                                                foreach ($clientes as $cliente) { 
                                                                                                    echo '<tr>';
                                                                                                    echo '<td>'.$cliente->idClientes.'</td>';
                                                                                                    echo '<td>'.$cliente->NombreEmpresa.'</td>';
                                                                                                    ...
                                                                                                    echo '<td>
                                                                                                                ...
                                                                                                                <a class="btn btn-teal tooltips" href="'.base_url().'clientes/editar/'.$cliente->idClientes.'" data-placement="top" data-original-title="Editar Cliente">
                                                                                                                    <i class="fa fa-edit"></i>
                                                                                                                </a>
                                                                                                                <a class="btn btn-bricky tooltips" href="'.base_url().'clientes/borrar/'.$cliente->idClientes.'" data-placement="top" data-original-title="Borrar Cliente">
